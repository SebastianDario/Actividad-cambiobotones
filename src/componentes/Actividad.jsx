...
function Actividad(props) {
    ...
    const actuimg1 = () => {
        ...
        divConFondo.style.backgroundImage = "url('src/img/3d.jpg')";
      }
      const actuimg2 = () => {
        const divConFondo = document.querySelector('.fondo');
        divConFondo.style.backgroundImage = "url('src/img/car.jpg')";
      }
      const actuimg3 = () => {
        const divConFondo = document.querySelector('.fondo');
        divConFondo.style.backgroundImage = "url('src/img/code.jpg')";
      }
      const actuimg4 = () => {
        const divConFondo = document.querySelector('.fondo');
        divConFondo.style.backgroundImage = "url('src/img/K6Rz.gif')";
      }
    return (
        <div className='App'>
            <div className="row">
                <div className="col-12 col-lg-6 fondo d-flex flex-column justify-content-center align-items-start ps-5">
                    <h1>{titulo}</h1>
                    <h4>{software}</h4>
                    <p>{cursos}</p>
                ...
                <div className="col-12 col-lg-6 d-flex justify-content-center align-items-center">
                    <div className='no d-flex flex-column  '>
                        ...
                        <button onClick={actuimg1} type='button' className='btnimg'>
                            <img className='imgs' src="src/img/3d.jpg" alt="" width="100px" />
                        </button>
                        <button onClick={actuimg2} type='button' className='btnimg'>
                        <img className='imgs' src="src/img/car.jpg" alt="" width="100px" />
                        </button>
                        <button onClick={actuimg3} type='button' className='btnimg'>
                            <img className='imgs' src="src/img/code.jpg" alt="" width="100px" />
                        </button>
                        <button onClick={actuimg4} type='button' className='btnimg'>
                            <img className='imgs' src="src/img/K6Rz.gif" alt="" width="100px" />
                        </button>
                    </div>
                    </div>
